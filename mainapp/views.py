...
def test_context(request):
    context = {
        ...
        'product_of_promotions': [
        {'name': 'Черный рюкзак Nike Heritage', 'price': '2 345,00'},
        {'name': 'Черные туфли на платформе с 3 парами люверсов Dr Martens 1461 Bex', 'price': '3 590,00'}
        ],
    }
